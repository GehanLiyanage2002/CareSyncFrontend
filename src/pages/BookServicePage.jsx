                      ...
                      <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-thin">
                        {schedules.map((schedule, idx) => (
                          <button
                            ...
                            className={`flex flex-col items-center justify-center p-3 rounded-2xl border text-center transition-all duration-300 min-w-[75px] ${selectedDateObj?.schedule_date === schedule.schedule_date
