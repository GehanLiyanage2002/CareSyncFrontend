      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-24">
          ...
          <div>
            ...
            <div className="flex justify-between py-3 border-b border-gray-200 dark:border-gray-700 text-sm text-gray-500 dark:text-gray-400">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              ...
              <div className="w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center hover:bg-[#3b82f6] hover:text-white transition-colors cursor-pointer text-gray-600 dark:text-gray-300">
