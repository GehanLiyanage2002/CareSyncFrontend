  ...
  useEffect(() => {
    ...
    if (docId) {
      const fetchDates = async () => {
        ...
        try {
          const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/appointments/configured-dates/${docId}`);
  ...
  useEffect(() => {
    ...
    if (selectedDate && docId) {
      const fetchSlots = async () => {
        ...
        try {
          const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/appointments/slots/${docId}?date=${selectedDate.valueDate}`);
          if (res.data.success) {
            ...
            <div className="p-4 space-y-2">
              ...
              <div className="flex gap-2 mt-3 print:hidden">
                ...
                <button
                  ...
                  className="flex-1 bg-gray-900 hover:bg-gray-800 dark:bg-white dark:hover:bg-gray-100 text-white dark:text-gray-900 font-bold py-2 rounded-xl transition text-sm"
                >
                  Close
                </button>
              </div>
