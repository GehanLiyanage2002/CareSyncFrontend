        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 min-h-[300px]">
          {loading ? (
            ...
            reviews.map((testimonial, index) => (
              <div key={testimonial.id || index} className="bg-white rounded-3xl p-8 shadow-[0_15px_40px_rgba(0,0,0,0.04)] flex flex-col items-center text-center transition-transform duration-300 hover:-translate-y-2 border border-white hover:border-blue-100">
                
                {/* Profile Image with Badge */}
                <div className="relative mb-6">
                  <img 
                    src={testimonial.image || placeholderImages[index % placeholderImages.length]} 
                ...
                {/* Patient Info */}
                <h4 className="text-[#111827] font-bold text-lg">
