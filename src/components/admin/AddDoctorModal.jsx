...
const AddDoctorModal = ({ token, onClose, onSuccess }) => {
 ...
 try {
 await axios.put(`${import.meta.env.VITE_API_URL}/api/admin/doctors/${doctorId}/profile-image`, fd, {
 ...
 try {
 const res = await axios.post(`${import.meta.env.VITE_API_URL}/api/admin/doctors`, {
 ...basic,
 ...professional,
 ...
 await axios.put(`${import.meta.env.VITE_API_URL}/api/admin/doctors/${createdId}/schedule`, {
 schedule_date,
 ...
 try {
 await axios.put(`${import.meta.env.VITE_API_URL}/api/admin/doctors/${createdId}/fee`,
 { fee: Number(fee) },
 { headers: { Authorization: token } }
 );
