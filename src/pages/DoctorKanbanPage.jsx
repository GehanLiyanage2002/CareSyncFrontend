  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-gray-900 font-sans text-slate-800 dark:text-white selection:bg-teal-100 flex flex-col">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-6 md:p-10">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-slate-100 dark:border-gray-700 p-8 min-h-[600px] overflow-hidden">
        ...
        <div className="mt-12 flex justify-center pb-8">
          <button 
            ...
            className="flex items-center gap-2 px-6 py-3 bg-white dark:bg-gray-800 text-slate-600 dark:text-gray-300 hover:text-teal-600 font-medium rounded-full shadow-sm hover:shadow-md border border-slate-200 dark:border-gray-600 hover:border-teal-200 transition-all duration-300 group"
          >
