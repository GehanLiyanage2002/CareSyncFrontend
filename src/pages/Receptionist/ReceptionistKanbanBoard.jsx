              ...
              <div className="flex-1 p-5 space-y-4 min-h-[500px]">
                {tasks.map((task) => (
                  <div
                    ...
                    className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-slate-100 dark:border-gray-700 shadow-sm cursor-pointer hover:shadow-md hover:border-blue-200 dark:hover:border-blue-600 transition-all"
                  >
